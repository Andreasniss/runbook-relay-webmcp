...
**Release-candidate evidence, verified 1 September 2026:** production build, lint, TypeScript, all 22 automated tests, the 50-case evaluation contract, and the structural agent-interface budget pass. The scenario and external action are synthetic; no production system is connected.
